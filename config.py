...
# Alavancagem por tier (autorizado 25/06): BRONZE 3-5x, PRATA 5-10x, OURO 10-20x
ALAVANCAGEM_POR_TIER_V5 = {"BRONZE": 5, "PRATA": 10, "OURO": 20}
...
ADX_MIN_GLOBAL = 15
RVOL_MIN_BY_TF = {"30m": 0.45, "1h": 0.45}
RVOL_MIN_EXEC = 0.45
...
BB_TOPO_BLOQUEAR    = False   # bb_topo vira penalidade (nao bloqueio)
BB_FUNDO_BLOQUEAR   = False   # bb_fundo vira penalidade (nao bloqueio)
