...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/josue/Usersjosuegauss-dna/.opencode/.gsd-surface.json`
(sibling to `C:/Users/josue/Usersjosuegauss-dna/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/josue/Usersjosuegauss-dna/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`C:/Users/josue/Usersjosuegauss-dna/.opencode/skills`).
...
`C:/Users/josue/Usersjosuegauss-dna/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/josue/Usersjosuegauss-dna/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/josue/Usersjosuegauss-dna/.opencode/.gsd-surface.json`
Install profile marker: `C:/Users/josue/Usersjosuegauss-dna/.opencode/.gsd-profile`
Skill dirs: `C:/Users/josue/Usersjosuegauss-dna/.opencode/skills/gsd-*/`
Engine module: `C:/Users/josue/Usersjosuegauss-dna/.opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/josue/Usersjosuegauss-dna/.opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
