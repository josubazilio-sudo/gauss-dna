...
```bash
INIT=$(node "C:/Users/josue/Usersjosuegauss-dna/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/josue/Usersjosuegauss-dna/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
