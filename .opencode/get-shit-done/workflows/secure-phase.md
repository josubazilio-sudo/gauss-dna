...
```
Agent(
  prompt="Read C:/Users/josue/Usersjosuegauss-dna/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/josue/Usersjosuegauss-dna/.opencode/get-shit-done/templates/SECURITY.md`
