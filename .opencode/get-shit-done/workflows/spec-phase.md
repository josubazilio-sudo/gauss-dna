...
```bash
INIT=$(node "C:/Users/josue/Usersjosuegauss-dna/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/josue/Usersjosuegauss-dna/.opencode/get-shit-done/templates/spec.md.
