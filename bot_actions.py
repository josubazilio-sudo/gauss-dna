...
def analyze(sym, candles):
    ...
    rsi_not_top    = rsi < 70   # LONG: não entrar quando sobrecomprado
    ...
    long_cross=(any_cross_bull and score>10 and adx>15 and
                ...
                v_strong and not_ext_long and price>e200*0.97 and rsi<70)
    ...
    long_pullback=(pullback_bull and trend_bull_relaxed and (macd_bull or macd_recovering) and
                   ...
                   above_vwap and score>15 and not any_cross_bull and rsi<70)
    ...
    not_ext_long_tight  = (price - e21) / atr < 2.5 and rsi < 70
    ...
    long_bb_break  = (bb_break_long  and kalman_up   and k_short_rising  and
                      ...
                      not ext_above_ema21 and not vol_drying and rsi < 70)
    ...
    if not sig:
        if score > 25:
            ...
            if rsi >= 70: b.append(f"rsi={rsi:.1f} sobrecomprado (≥70)")
...
async def run_mtf_cycle(session, last_sig, coins):
    ...
    for sym, label, short in coins:
        ...
        h4_bull = r4h["score"] > 15 and r4h.get("tbull_r", False) and r4h["adx"] >= 13 and h4_rsi < 70 and h4_vol
